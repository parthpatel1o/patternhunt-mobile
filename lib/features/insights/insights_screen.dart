              ...
              child: SizedBox(
                ...
                child: pattern.imageUrl != null
                    ...
                    : ColoredBox(
                        ...
                        child: Center(
                          child: Text('No photo', style: Theme.of(context).textTheme.labelSmall?.copyWith(color: AppColors.muted)),
                        ),
                      ),
              ),
            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  GridView.count(
                    ...
                    children: [
                      _MetricCell(label: 'Upvotes', value: '${pattern.voteCount}'),
                      _MetricCell(label: 'Saves', value: '${pattern.saveCount}'),
                      _MetricCell(
                        label: isPdfCta ? 'Downloads' : 'Store clicks',
                        value: '$ctaCount',
                        emphasize: true,
                      ),
                      _MetricCell(label: 'All-time rank', value: rankValue),
                    ],
                  ),
                ],
              ),
